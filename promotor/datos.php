...
if (isset($_GET['accion'])) {
  ...
  switch ($_GET['accion']) {
    ...
    case 'update':
      ...
      if (!isset($datos[0])) {
        message('El promotor no existe', 'danger');
      }
...
$datos = $web->DB->GetAll($sql, array($_SESSION['cveUser'], 2));
//Verificar si se tiene serultados
if (!isset($datos[0])) {
  message('index datos', 'Error, el Promotor no existe', 'danger', $web);
}
...
$web->smarty->assign('promotor', $datos[0]);
