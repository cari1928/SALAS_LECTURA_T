...
if ($_SESSION['roles'] == 'A') {
  ...
  if (isset($_GET['info1'])) {
    ...
    $sql = "select distinct letra,nombre, cveusuario from abecedario  inner join lectura on lectura.cveletra=abecedario.cve inner join usuarios on usuarios.cveusuario=lectura.cvepromotor where  cveperiodo=" . $_GET['info1'] . "order by nombre";
